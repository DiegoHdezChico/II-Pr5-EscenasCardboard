...
public partial class @Control: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Jugador"",
            ""id"": ""28149686-fb9f-4726-a6b2-4f14226672ed"",
            ""actions"": [
                {
                    ""name"": ""Mover"",
                    ""type"": ""Value"",
                    ""id"": ""b54c334e-2f10-4997-9974-0366ac36a8b7"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4e5c3b8a-34ab-4ac8-a2a1-23ecf2ad2c32"",
    ...
    ~@Control()
    {
        UnityEngine.Debug.Assert(!m_Jugador.enabled, "This will cause a leak and performance issues, Control.Jugador.Disable() has not been called.");
    }
    ...
    public struct JugadorActions
    {
        ...
        /// </summary>
        public JugadorActions(@Control wrapper) { m_Wrapper = wrapper; }
        /// <summary>
